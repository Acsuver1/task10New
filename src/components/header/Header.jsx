...
<div className="flex  justify-between items-center bg-[#F5F5F5] p-6 ">
       <div>
       ...
       <br /><br />
             ...
             <a href=" "> <p className="w-[55px] h-[15px]  text-[#FFFFFF] text-[12px] mx-[-60px]">{(t("t13"))}</p></a>
                </div>
             ...
             <a href=""> <p className="w-[55px] h-[15px]  text-[#FFFFFF] text-[12px] mx-[-60px]">{(t("t12"))}</p></a>
                </div>
              ...
              <a href=""> <p className="w-[55px] h-[15px]  text-[#FFFFFF] text-[12px] mx-[-60px]">{(t("t11"))}</p></a>
                </div>
